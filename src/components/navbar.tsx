...
export default function NavBar() {
  ...
  return (
    <nav
      className={`bg-black px-4 py-4 w-full transition-all duration-300 ${
...
function NavLinks({ mobile = false }: { mobile?: boolean }) {
  const linkClass = mobile
    ? "block py-2 text-sm font-medium text-white hover:text-primary transition-colors"
    : "relative text-sm font-medium text-white hover:text-primary transition-colors";
